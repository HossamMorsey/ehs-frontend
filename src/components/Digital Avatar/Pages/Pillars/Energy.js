...
import { energy } from "../../../../assets/pillarsData";
import { Button, Select, Collapse, Typography, Modal, Input } from "antd";
...
function Energy() {
  const [energyIndicators, setEnergyIndicators] = useState([]);
  ...
  useEffect(() => {
    ...
    setEnergyIndicators(energy);
    setFilteredIndicators(energyIndicators);
    console.log(":ENERGY IS HERE", energyIndicators);
  ...
  const handleChange = (value) => {
    ...
    const filtered = energyIndicators.filter((indicator) =>
  ...
  const onSearch = (value, _e) => {
    ...
    const searched = energyIndicators.filter((indicator) =>
  ...
  const handleOnClickFilterSource = (source) => {
    ...
    setFilteredIndicators(energyIndicators);
    const sourced = energyIndicators.filter((indicator) =>
